...
import { buildBenchmarkRun, downloadBenchmarkJson } from "@/lib/trial-types";
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-3">
        ...
        {status === "complete" ? (
          <Button variant="outline" size="sm" className="w-full" onClick={exportBenchmark}>
